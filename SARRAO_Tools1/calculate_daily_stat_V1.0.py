...
#f_out1 = 'D:/2020/SARRA_O/python_script/era5_data/daily-mean_%d.nc' % day1
#ma_variable1 = 'tp'


def daily_min(day,path_in, path_out, stat,exp_in,exp_out,ma_variable):
    f_in="%s/%s_%s.nc" %(path_in,exp_in,day)
    f_out = "%s/%s_%s.nc" % (path_out, exp_out, day)
    # day = 20170101
    ...
    with Dataset(f_in) as ds_src:
        ...
        for idx in indices:
            if not tp_values_set:
                ...
                if stat=="mean":
                    data = np.mean(data, var_tp[idx, :, :])
                if stat=="min":
                    data = np.minimum(data, var_tp[idx, :, :])
                if stat=="max":
...
day1="20190101"
path_in1 = "D:/2020/SARRA_O/python_script/era5_data/"
path_out1= "D:/2020/SARRA_O/python_script/era5_data/"
stat1="max"
exp_in1="era5_africa_u10"
exp_out1="era5_africa_u10mx"
ma_variable1="u10"
daily_min(day1,path_in1, path_out1, stat1,exp_in1,exp_out1,ma_variable1)
