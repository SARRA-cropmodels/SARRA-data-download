...
f_in1 = 'D:/2020/SARRA_O/python_script/era5_data/tp_%d.nc' % day1
f_out1 = 'D:/2020/SARRA_O/python_script/era5_data/daily-tp_%d.nc' % day1
ma_variable1 = 'tp'


def daily_sum(day, f_in, f_out, ma_variable):
    # day = 20170101
...
daily_sum(day1, f_in1, f_out1,ma_variable1)
