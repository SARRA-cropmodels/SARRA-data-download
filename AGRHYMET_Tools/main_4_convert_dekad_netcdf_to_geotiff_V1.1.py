...
dekad_path_data_in = cg.bdir + 'corrected/dekad/'
daily_path_data_in = cg.bdir + 'corrected/daily/'
#
dekad_path_data_in = cg.bdir + '2_aggregation/2_data_ERA5_dekadlyAg/'
daily_path_data_in = cg.bdir + '2_aggregation/2_data_ERA5_dailyAg/'

dekad_path_data_out = cg.bdir + 'tif_data/dekad/'
daily_path_data_out = cg.bdir + 'tif_data/daily/'
...
for file in files:
    if file.endswith('.nc'):
        ...
        var_name_folder = path_data_out + var_name + '/'
