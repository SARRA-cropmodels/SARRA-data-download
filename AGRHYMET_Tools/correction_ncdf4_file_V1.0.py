...
dekad_path_data_out = cg.bdir + 'corrected/dekad/'
daily_path_data_out = cg.bdir + 'corrected/daily/'

# Affectation -dekad or daily

path_data_in = dekad_path_data_in
path_data_out = dekad_path_data_out
